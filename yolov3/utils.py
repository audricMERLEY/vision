...
def detect_image_path(Yolo, image_path, output_path, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
    original_image      = cv2.imread(image_path)
    return detect_image(Yolo, original_image, output_path, input_size, show, CLASSES, score_threshold, iou_threshold, rectangle_colors)
